...
fixed_vocabulary = ['barrier', 'traffic barrier', 'bicycle', 'bus', 'car', 
...
def parse_config():
    ...
    parser.add_argument("--output_root", default="data/occ3d/san_qwen_scene")
...
if __name__ == '__main__':
    ...
    if args.fixed_vocab:
        with open(os.path.join(output_root, 'vocab.txt'), 'w') as f:
