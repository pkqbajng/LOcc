...
language_gt_root = 'san_seg_gts'
ovo_seg_root = 'san_seg'
...
train_pipeline = [
    ...
    dict(
        type='Collect3D', keys=['img_inputs', 'gt_depth', 'ovo_segs', 'ovo_seg_masks'])
]

test_pipeline = [
    dict(type='PrepareImageInputs', data_config=data_config, sequential=sequential),
    dict(
        type='LoadAnnotationsBEVDepth',
        bda_aug_conf=bda_aug_conf,
        classes=class_names,
...
load_from="ckpts/bevstereo-r50-cbgs.pth"